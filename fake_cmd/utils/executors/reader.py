...
from slime_core.utils.typing import Type, Union, Missing, MISSING
...
class PipePopenReader(PopenReader):
    ...
    readonly_attr__ = ("selector", "bytes_parser")
...
class PexpectReader(ExecutorComponent[PexpectExecutor]):
    ...
    def parse_content(self, content: Union[str, bytes, None]) -> str:
        ...
        if isinstance(content, bytes):
            ...
            logger.warning(f"Unsupported type found: {type(content)}")
            return ""
