from slime_core.utils.typing import Union, Tuple
...
class Config:
    ...
    def __init__(self) -> None:
        ...
        self.version: Tuple[int, int, int] = tuple(
            int(v) for v in __version__.split(".")[:3]
        )
        # For system settings.
...
def version_check(
    ...
    *,
    ...
    if version is None:
        ...
        check_passed = ((not min_version) or version >= tuple(min_version)) and (
